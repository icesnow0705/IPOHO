...
@WebServlet("/spacephoto/showpicture")
public class ShowPicture extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String spacePhoto = req.getParameter("spacePhoto").trim();
			pstmt.setString(1, spacePhoto);
...
//				InputStream in = new BufferedInputStream(rs.getBinaryStream("PIC"));
			...
			System.out.println(req.getParameter("spacePhoto").trim());
		}
	}
