...
DROP SEQUENCE SUPPLY_LIST_ID_SEQ;
DROP TABLE SPACE_COMM;
DROP SEQUENCE SPACE_COMM_ID_SEQ;
DROP TABLE MEMBER_COMM;
DROP SEQUENCE MEMBER_COMM_ID_SEQ;
...
MEMBER_SINGUP_DATE   DATE NOT NULL,
...
SPACE_DETAIL_CHARGE   NUMBER(6) CHECK (SPACE_DETAIL_CHARGE >= 0) NOT NULL,
SPACE_DETAIL_TEXT CLOB,
...
--SUPPLY_LIST_TYPE   VARCHAR2(20 NOT NULL,
...
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'am6319146', 'ZHcoPk', '馬全德', '馬哥', 'gbauer9@tibame.edu.com', '0911-332233', '新北市中和區','1990-05-04', 'M', '美國','2015-08-12', 1, 'T' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'bk53292916a', 'IML0bFfYUTo', '張互賓', '互賓', 'svolkes8@gmail.com', '0922-778877', '台北市中正區', '1969-03-25', 'M', '台灣','2016-04-27', 2, 'T' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'tinsdgfl8421', '5354e1r48gd', '劉宜婷', '宜婷', 'yitibkjoldk511@tibame.edu.com', '0925-587786', '新北市中和區', '1981-05-03', 'F', '台灣','2019-05-05', 2, 'T' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'lasjoir41', '56cvb41n89rt', '詹姆士', '喇叭詹', 'lejdflkgd1459we@gmail.com', '0915-547865', '新北市三重區', '1990-05-11', 'M', '台灣','2020-03-23', 2, 'T' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'wufsklr989', '48df1g8gft', '黃彬華', '彬華', 'hundfg4789@tibame.edu.com', '0925-452722', '桃園市中壢區', '1992-08-17', 'M', '英國','2020-09-05', 1, 'T' );
INSERT INTO MEMBER ( MEMBER_ID, MEMBER_ACCOUNT, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_EMAIL, MEMBER_PHONE, MEMBER_ADDRESS, MEMBER_BIRTH, MEMBER_SEX, MEMBER_COUNTRY, MEMBER_SINGUP_DATE, MEMBER_AUTH, MEMBER_STATUS ) VALUES ( 'MEM' || lpad(MEMBER_ID_SEQ.NEXTVAL, 5, '0' ), 'jbiopgs25689', 'we87487dd', '馬英九', '小九', 'jigksdiofe454@gmail.com', '0973-894815', '新北市蘆洲區', '1995-07-02', 'M', '台灣','2020-09-11', 1, 'F' );
...
INSERT INTO SPACE ( SPACE_ID, MEMBER_ID, EMP_ID, SPACE_ADDRESS, SPACE_LNG, SPACE_LAT, SPACE_NAME, SPACE_TEXT, SPACE_TYPE, SPACE_EQUMENT, SPACE_CONTAIN, SPACE_RULE, SPACE_REFUND, SPACE_STATUS, SPACE_SIGNUP_DATE, SPACE_ONSALE_DATE ) VALUES ( 'SPACE' || lpad(SPACE_ID_SEQ.NEXTVAL, 5, '0'), 'MEM00003', 'EMP00003', '台北市大安區復興南路一段279巷33號', '12.3456', '9.8765', '藝文空間活動場地', '場地介紹1', '攝影棚', '冷氣', '10', '租借單位或團體應盡善良使用人之責任。','24小時內取消您的預定', 'T', '2019/11/23', '2019/11/24' );
INSERT INTO SPACE ( SPACE_ID, MEMBER_ID, EMP_ID, SPACE_ADDRESS, SPACE_LNG, SPACE_LAT, SPACE_NAME, SPACE_TEXT, SPACE_TYPE, SPACE_EQUMENT, SPACE_CONTAIN, SPACE_RULE, SPACE_REFUND, SPACE_STATUS, SPACE_SIGNUP_DATE, SPACE_ONSALE_DATE ) VALUES ( 'SPACE' || lpad(SPACE_ID_SEQ.NEXTVAL, 5, '0'), 'MEM00002', 'EMP00004', '台北市南港區忠孝東路七段371號B1AF南側廣場出口2旁', '50.1234', '50.9876', '收多易共同工作空間', '場地介紹2', '共用工作空間', '投影機', '30', '租借單位或團體應盡善良使用人之責任。', '24小時內取消您的預訂', 'T', '2020/02/01', '2020/02/01' );
INSERT INTO SPACE ( SPACE_ID, MEMBER_ID, EMP_ID, SPACE_ADDRESS, SPACE_LNG, SPACE_LAT, SPACE_NAME, SPACE_TEXT, SPACE_TYPE, SPACE_EQUMENT, SPACE_CONTAIN, SPACE_RULE, SPACE_REFUND, SPACE_STATUS, SPACE_SIGNUP_DATE, SPACE_ONSALE_DATE, SPACE_OFFSALE_DATE) VALUES ( 'SPACE' || lpad(SPACE_ID_SEQ.NEXTVAL, 5, '0'), 'MEM00004', 'EMP00003', '台北市大安區東豐街66號3樓307室', '40.1234', '-40.9876', '大安小樹屋', '場地介紹3', '親子活動', '冷氣', '15', '租借單位或團體應盡善良使用人之責任。', '24小時內取消您的預訂', 'F' ,'2020/05/13', '2020/05/23', '2020/07/25' );
...
INSERT INTO SPACE_DETAIL( SPACE_DETAIL_ID, SPACE_ID, SPACE_DETAIL_FREEDATE, SPACE_DETAIL_CHARGE, SPACE_DETAIL_TEXT ) VALUES ( 'SD' || lpad(SPACE_DETAIL_ID_SEQ.NEXTVAL, 5, '0'), 'SPACE00001', '2019-12-13', 400, '這是場地介紹一' );
INSERT INTO SPACE_DETAIL( SPACE_DETAIL_ID, SPACE_ID, SPACE_DETAIL_FREEDATE, SPACE_DETAIL_CHARGE, SPACE_DETAIL_TEXT ) VALUES ( 'SD' || lpad(SPACE_DETAIL_ID_SEQ.NEXTVAL, 5, '0'), 'SPACE00002', '2020-02-03', 250, '這是場地介紹二' );
INSERT INTO SPACE_DETAIL( SPACE_DETAIL_ID, SPACE_ID, SPACE_DETAIL_FREEDATE, SPACE_DETAIL_CHARGE, SPACE_DETAIL_TEXT ) VALUES ( 'SD' || lpad(SPACE_DETAIL_ID_SEQ.NEXTVAL, 5, '0'), 'SPACE00003', '2020-05-16', 350, '這是場地介紹三' );
...
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, EMP_ID, FORM_CREATEDATE, FORM_TITLE, FORM_CONTENT) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00003', 'EMP00002', '2020-01-27', '租借問題相關', '請問你們的預約會保留多久呢' );
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, FORM_CREATEDATE, FORM_TITLE, FORM_CONTENT) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00001', '2020-09-17', '網站錯誤回報', '剛剛的網頁存取行為發生了問題' );
INSERT INTO FORM_LIST(FORM_LIST_ID, MEMBER_ID, FORM_CREATEDATE, FORM_TITLE, FORM_CONTENT) VALUES ( 'FORMS' || lpad(FORM_LIST_ID_SEQ.NEXTVAL, 7, '0'), 'MEM00003', '2020-09-19', '投訴', '場地髒亂，場主不處理' );


INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATEDATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( 'OMS' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 6, '0'), 'MEM00001', '2020-09-18', 2000, 'T' );
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATEDATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( 'OMS' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 6, '0'), 'MEM00002', '2020-09-18', 1750, 'T' );
INSERT INTO ORDER_MASTER(ORDER_MASTER_ID, MEMBER_ID, ORDER_CREATEDATE, ORDER_AMOUNT, ORDER_STATUS) VALUES ( 'OMS' || lpad(ORDER_MASTER_ID_SEQ.NEXTVAL, 6, '0'), 'MEM00003', '2020-09-18', 2100, 'T' );

INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), 'OMS' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 6, '0'), 'SD00001', ('2020-09-18 15:30'), '2020-09-18 18:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), 'OMS' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 6, '0'), 'SD00002', ('2020-09-18 15:30'), '2020-09-18 17:00' );
INSERT INTO ORDER_DETAIL(ORDER_DETAIL_ID, ORDER_MASTER_ID, SPACE_DETAIL_ID, RENT_START_TIME, RENT_END_TIME) VALUES ( 'OD' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 7, '0'), 'OMS' || lpad(ORDER_DETAIL_ID_SEQ.NEXTVAL, 6, '0'), 'SD00003', ('2020-09-18 15:30'), '2020-09-18 15:30' );
