...
<ul>
  <li><a href='listAllSpaceComment.jsp'>List</a> all SpaceComments.  <br><br></li>
  
  
  <li>
    <FORM METHOD="post" ACTION="spacecomment.do" >
        <b>輸入場地評價ID:</b>
...
<ul>
  <li><a href='addSpaceComment.jsp'>Add</a> a new SpaceComment.</li>
</ul>
</main>
<!--/main-->
</div>
